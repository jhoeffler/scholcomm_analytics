...
The European Commission mandates open access to publications. The compliance to this policy can be measured using the OpenAIRE Research Graph per project:
...
```{r variations, fig.cap="Open Access Compliance Rates of Horizon 2020 projects relative to funding activities, visualised as box plot. Projects with less than five publications are not shown individually."}
oa_monitor_ec %>%
...
About 77% of research pubilcations under the H2020 open access mandate are openly available. Figure \@ref(fig:variations) highlights a generally high rate of compliance with the open access mandate. However, uptake levels vary among and within the H2020 funding programmes. 
...
I put it all together and benchmark the rates of compliance with the H2020 open access mandate using data from the OpenAIRE Research Graph. The package `plotly`[@plotly] allows presenting the figure as interactive chart.
